...
1. [x] ~~Running all the system at 3.3V.~~ See [prototype_v1.0.md](https://github.com/4z7dtf/vx8_gps/blob/master/docs/prototype_v1.0.md) for details.
2. [x] ~~Reducing the microcontroller speed to 8MHz or even lower.~~ See [Release v1.0](https://github.com/4z7dtf/vx8_gps/releases/tag/v1.0) ([commit 9e8273a](https://github.com/4z7dtf/vx8_gps/commit/9e8273abed9b53197791b6e432649a282e6ca909)) .
